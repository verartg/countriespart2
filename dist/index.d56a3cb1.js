...
async function fetchCountries() {
    try {
        const result = await _axiosDefault.default.get('https://restcountries.com/v2/name/' + INPUT.value);
    ...
    `;
        function valuta() {
            if (country.currencies.length === 2) return "and you can pay with " + country.currencies[0].name + " and " + country.currencies[1].name + "'s";
            else if (country.currencies.length === 1) return "and you can pay with " + country.currencies[0].name;
        }
    } catch (err) {
        console.error(err);
    }
